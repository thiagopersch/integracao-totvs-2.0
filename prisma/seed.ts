...
async function main() {
  ...
  await prisma.fichaAutomationRun.deleteMany()
  await prisma.mapeadorProjeto.deleteMany()
  await prisma.mapeadorTema.deleteMany()
  await prisma.mapeadorTemplateProjeto.deleteMany()
